...
public class NetBookcase : NetworkBehaviour
{
    ...
    public string state;
    [Server]
    public void GenerateAsProp(long propSeed)
    {
    ...
    [ClientRpc]
    public void RpcGeneratePropWithState(string state)
    {
        //Debug.Log(state);
    ...
    public void GenerateAsPuzzle(long puzzleSeed)
    {
    ...
    public void Start()
    {
        GenerateAsProp(Random.Range(int.MinValue, int.MaxValue));
    }
